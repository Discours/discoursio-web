...
const routes = ['/', '/docs', '/examples', '/tutorial', '/contributors', '/resources', '/media']
...
async function generateSitemap() {
  ...
  const tutorialLookup = JSON.parse(
    await readFile('node_modules/@solid.js/docs/dist/tutorials/en/directory.json')
  )
