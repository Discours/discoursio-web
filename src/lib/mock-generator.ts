...
export const aCommunity = (overrides?: Partial<Community>): Community => {
  return {
    desc:
      overrides && overrides.hasOwnProperty('desc') ? overrides.desc! : 'in',
    name:
  ...
  return {
    ...
    replyTo:
      overrides && overrides.hasOwnProperty('replyTo')
        ...
        : aShout(),
    slug:
      overrides && overrides.hasOwnProperty('slug') ? overrides.slug! : 'est',
    subtitle:
  ...
  return {
    ...
    replyTo:
      overrides && overrides.hasOwnProperty('replyTo')
        ...
        : 'maxime',
    slug:
      overrides && overrides.hasOwnProperty('slug') ? overrides.slug! : 'hic',
    subtitle:
      overrides && overrides.hasOwnProperty('subtitle')
        ? overrides.subtitle!
        : 'vel',
  ...
  return {
    error:
      overrides && overrides.hasOwnProperty('error')
        ...
        : 'animi',
    shout:
      overrides && overrides.hasOwnProperty('shout')
        ? overrides.shout!
        : aShout(),
  }
}
  ...
  return {
    ...
    parents:
      overrides && overrides.hasOwnProperty('parents')
        ...
        : ['labore'],
    pic:
      overrides && overrides.hasOwnProperty('pic')
        ? overrides.pic!
        : 'mollitia',
    slug:
...
export const aUser = (overrides?: Partial<User>): User => {
  return {
    bio:
      overrides && overrides.hasOwnProperty('bio') ? overrides.bio! : 'itaque',
    communities:
...
export const aUserNotification = (
  ...
  return {
    ...
    user:
      overrides && overrides.hasOwnProperty('user') ? overrides.user! : 9424,
    values:
