...
export const communitieslist: Writable<Partial<Community>[]> =
  writable(communitiesData)
export const shoutslist: Writable<Array<Shout | Partial<Shout>>> =
  writable(shoutsData)
...
export const communities: Writable<{ [slug: string]: Partial<Community> }> =
  writable({})
