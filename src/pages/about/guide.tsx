...
export default () => {
  ...
  return (
    <>
      ...
      <Meta name='description' content='Горизонтальная редакция: как работает открытый журнал' />
      <Meta name='keywords' content='Discours.io, правила, terms of use' />
      <Meta property='og:title' content='Как устроен Дискурс' />
      <Meta property='og:description' content='Горизонтальная редакция: как работает открытый журнал' />
      ...
      <article class='container'>
        <div class='row'>
          <div class="col-md-2">
            <nav class="content-index">
              <ul class="nodash">
                <li><a href="#about">Как устроен Дискурс</a></li>
                <li>
                  <a href="#how-it-works">Как устроен сайт Дискурса</a>
                </li>
        ...
        */}
              ...
              <p>
                ...
                но&nbsp;и&nbsp;на&nbsp;страницах в&nbsp;<a href='https://facebook.com/discoursio/' target='_blank'>Фейсбуке</a>,{' '}
                <a href='https://vk.com/discoursio' target='_blank'>ВКонтакте</a>{' '}
                и&nbsp;<a href='https://t.me/discoursio' target='_blank'>Телеграме</a>. А&nbsp;ещё раз в&nbsp;месяц мы&nbsp;отправляем <a href='#subscribe'>почтовую рассылку</a>{' '}
                с&nbsp;дайджестом лучших материалов.
              </p>
              <p>
                Если вы&nbsp;хотите сотрудничать, что-то обсудить или предложить &mdash; пожалуйста, пишите
                на&nbsp;<a href='mailto:welcome@discours.io' target='_blank'>welcome@discours.io</a>. Мы&nbsp;обязательно ответим.
              </p>
            </div>
          </div>
        </div>
