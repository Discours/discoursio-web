		...
		<div class="row">
			...
			<div class="col-sm-7 col-sm-offset-2 post-body margin-top-30px">
				<p>
					...
					с&nbsp;<a href="/manifest">открытой редакцией</a>. У&nbsp;нас нет главного
					редактора, инвестора и&nbsp;вообще никого, кто бы принимал единоличные
					решения. Вместо традиционных иерархий Дискурс основан на принципах прямой
					демократии: в нашем горизонтальном сообществе все редакционные вопросы
				...
				<ul>
					<li>
						<p>
							<a href="/topic">Темы</a>&nbsp;— у нас публикуются исследования, обзоры,
					...
					<li>
						<p>
							...
							художественные произведения: литература, живопись, музыка, фотографии,
							видео. Этот раздел помогает прозвучать новому искусству, которое создают
			  ...
			  <p>
				...
				<p>
					...
					<a href="/topic/sex">секс</a> и т.д.) или в&nbsp;серии (как «<a
						href="/topic/zakony-mira">Законы мира</a
					>» или «<a href="/topic/za-liniey-mannergeyma"
				...
				{#if $token}
					<section>
						...
						<p>
							...
							фотографов, режиссеров, философов, ученых и других замечательных людей.
							Каждый может
					...
					<p>
						Все присылаемые в&nbsp;Дискурс материалы попадают в&nbsp;<b>«Редакцию»</b
						>. Это внутренний раздел сайта, где участники сообщества решают, что будет
						опубликовано в Дискурсе. Как только работа получает одобрение как минимум
						...
						Жестких сроков рассмотрения материалов у&nbsp;нас нет, иногда это занимает
						час, иногда месяц, обычно&nbsp;— несколько дней.
					</p>
				{:else}
					<section>
						<p>
				...
				<p>
					Дискурс&nbsp;— журнал с&nbsp;совместным редактированием. Совершенствовать
					тексты нам помогает <b>система ремарок</b>. Вы&nbsp;можете выделить часть
					текста в&nbsp;любой статье и&nbsp;оставить к&nbsp;ней замечание, вопрос или
					предложение&nbsp;— автор текста получит совет на&nbsp;почту и&nbsp;сможет
					его учесть. Так мы&nbsp;устраняем опечатки, неточности и&nbsp;советуем друг
				...
				<p>
					...
					интернет-редакцию&nbsp;— разместите его в&nbsp;google-документе, откройте
				...
				<ul>
					<li>
						<p>
							...
							голосуют за&nbsp;работы коллег и&nbsp;таким образом вносят свой вклад
					...
					<li>
						<p>
							...
							удостоверяют, что вы&nbsp;журналист и&nbsp;можете пользоваться всеми теми
					...
					<li>
						<p>
							...
							редакционного сообщества&nbsp;— несколько сотен журналистов,
							исследователей, художников, литераторов из&nbsp;разных стран&nbsp;—
					...
					<li>
						<p>
							...
							Дискурс&nbsp;— большое живое сообщество интеллектуалов, разбросанных
