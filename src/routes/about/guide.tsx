    ...
    <div class='row'>
      ...
      <div class='col-md-8 col-lg-6 offset-md-3'>
        ...
        <ul>
          <li>
            <p>
              <a href='/topic'>Темы</a>&nbsp;&mdash; у&nbsp;нас публикуются исследования, обзоры, эссе,
          ...
          <li>
            <p>
              ...
              произведения: литература, живопись, музыка, фотографии, видео. Этот раздел помогает прозвучать
              новому искусству, которое создают российские художники, писатели, режиссёры и&nbsp;музыканты.
            </p>
          </li>
          <li>
            <p>
              <a href='/topic/events'>События</a>&nbsp;— в&nbsp;этом разделе публикуются самые важные,
              по&nbsp;мнению редакции, культурные события России — выставки, лекции, концерты, кинопоказы,
              фестивали, художественные и политические&nbsp;акции. Напишите&nbsp;нам на&nbsp;
              <a href='mailto:welcome@discours.io' target='_blank'>
                почту
              </a>
              , если вы хотите разместить объявление. Мы делаем&nbsp;это на&nbsp;безвозмездной основе.
            </p>
          </li>
          <li>
            <p>
              <a href='/create' class='ng-scope' target='_blank'>
                Редакция
              </a>
              &nbsp;— это внутренний раздел, где появляются новые материалы, которые присылают
              в&nbsp;редакцию. Здесь авторы обсуждают, редактируют и&nbsp;оценивают публикации, определяя
              таким образом содержание журнала.
            </p>
          </li>
        </ul>
        <p>
        ...
        >
          ...
          <p>
            Все присылаемые в&nbsp;Дискурс материалы попадают в&nbsp;<b>&laquo;Редакцию&raquo;</b>. Это
            внутренний раздел сайта, где участники сообщества решают, что будет опубликовано
            в&nbsp;Дискурсе. Как только работа получает одобрение как минимум пятерых авторов открытой
            редакции, она немедленно публикуется в&nbsp;журнале. Если&nbsp;же материал набирает
            более&nbsp;20% голосов &laquo;против&raquo;, он&nbsp;не&nbsp;выходит и&nbsp;может быть отправлен
            на&nbsp;доработку. Жестких сроков рассмотрения материалов у&nbsp;нас нет, иногда это занимает
